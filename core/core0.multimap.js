    ...
    UMAP.MultiMap = UMAP.BaseObject.extend({
        ...
        */
        initialize: function (options) {
            ...
            var map_ready = $.Event('multimap:initialize');
            $(document).trigger(map_ready, { activeMap: this._activeMap, mapGroup: [this._activeMap], splitNum: "splitOne", target: this });
        },
        ...
        */
        ...
        /**
        *map元素的边框
        *@method _creatElement
        *@private
        */
        _creatElement: function () {
            this.elem = document.createElement('div');
            this.elem.setAttribute("class", "maplable");

            document.getElementById(this._mapContainer.containerOne).appendChild(this.elem.cloneNode());
            document.getElementById(this._mapContainer.containerTow).appendChild(this.elem.cloneNode());
            document.getElementById(this._mapContainer.containerThree).appendChild(this.elem.cloneNode());
            document.getElementById(this._mapContainer.containerFour).appendChild(this.elem.cloneNode());
        },
